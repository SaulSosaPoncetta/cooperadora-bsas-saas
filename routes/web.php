...
use App\Http\Controllers\PanelWebhookController;
...
// Webhook de MiGestión Panel (sin sesión: se autentica con la firma HMAC).
Route::post('/webhooks/panel', PanelWebhookController::class)->name('webhooks.panel');

// Pagar el abono: fuera del grupo "suscripcion" a propósito, para que el/la
// Presidente/a pueda usarlo justamente cuando la cuenta está bloqueada.
Route::post('/suscripcion/pagar', [SuscripcionController::class, 'pagar'])
    ->middleware('auth')
    ->name('suscripcion.pagar');

Route::get('/dashboard', [DashboardController::class, 'index'])->middleware(['auth', 'suscripcion', 'verified'])->name('dashboard');
...
Route::middleware(['auth', 'suscripcion', 'permission:gestionar usuarios'])->group(function () {
    Route::get('/usuarios', [UsuarioController::class, 'index'])->name('usuarios.index');
    Route::get('/usuarios/nuevo', [UsuarioController::class, 'create'])->name('usuarios.create');
    Route::post('/usuarios', [UsuarioController::class, 'store'])->name('usuarios.store');
    Route::post('/usuarios/presidencia', [UsuarioController::class, 'transferirPresidencia'])->name('usuarios.presidencia');
    Route::get('/usuarios/{usuario}/editar', [UsuarioController::class, 'edit'])->whereNumber('usuario')->name('usuarios.edit');
    Route::put('/usuarios/{usuario}', [UsuarioController::class, 'update'])->whereNumber('usuario')->name('usuarios.update');
    Route::delete('/usuarios/{usuario}', [UsuarioController::class, 'destroy'])->whereNumber('usuario')->name('usuarios.destroy');
});

Route::middleware(['auth', 'suscripcion', 'permission:gestionar establecimiento'])->group(function () {
...
Route::middleware(['auth', 'suscripcion', 'permission:ver socios'])->group(function () {
    Route::get('/socios', [SocioController::class, 'index'])->name('socios.index');
});

Route::middleware(['auth', 'suscripcion', 'permission:gestionar socios'])->group(function () {
...
Route::middleware(['auth', 'suscripcion', 'permission:ver comision directiva'])->group(function () {
    Route::get('/comision', [ComisionController::class, 'index'])->name('comision.index');
});

Route::middleware(['auth', 'suscripcion', 'permission:gestionar comision directiva'])->group(function () {
...
Route::middleware(['auth', 'suscripcion', 'permission:ver tesoreria'])->group(function () {
    Route::get('/tesoreria', [MovimientoTesoreriaController::class, 'index'])->name('tesoreria.index');
});

Route::middleware(['auth', 'suscripcion', 'permission:gestionar tesoreria'])->group(function () {
...
Route::middleware(['auth', 'suscripcion', 'permission:ver asambleas'])->group(function () {
...
Route::middleware(['auth', 'suscripcion', 'permission:gestionar asambleas'])->group(function () {
...
Route::middleware(['auth', 'suscripcion', 'permission:firmar actas'])->group(function () {
    Route::post('/asambleas/{asamblea}/elevar', [AsambleaController::class, 'elevar'])->name('asambleas.elevar');
});

Route::middleware(['auth', 'suscripcion', 'permission:ver bienes'])->group(function () {
...
Route::middleware(['auth', 'suscripcion', 'permission:gestionar bienes'])->group(function () {
...
Route::middleware(['auth', 'suscripcion', 'permission:ver reportes'])->group(function () {
...
Route::middleware(['auth', 'suscripcion', 'permission:gestionar reportes'])->group(function () {
